 ...
 */
void InitChineseFont(const char *fontPath, int fontSize, const char *allText, Font *g_chineseFont);
 ...
 * @return 成功返回0，失败返回-1
 */
int InitGameResources(GameResources *res, struct window_size *winSize); // 初始化所有资源，成功返回0，失败返回-1
